...
@Component({
  selector: 'aromia-facturados-stats',
  imports: [FormsModule, CommonModule, ChartModule],
  standalone: true,
  templateUrl: './aromia-facturados-stats.component.html',
  styleUrl: './aromia-facturados-stats.component.scss'
})
export class AromiaFacturadosStatsComponent implements OnInit {
  ...
  getData() {
    ...
    // this.api.graphics.getCotizacionesFacturadasStats(data).subscribe({
    //   next: (response) => {
    //     console.log('Facturados Stats', response);
    //     this.stats = response
